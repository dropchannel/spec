...
This document defines the operational conventions for versioning artefacts across the `dropchannel/` org. It is the authoritative reference for format requirements and templates. The decisions behind these conventions are recorded in `governance/adr/pending/ADR-XXXX-versioning-strategy.md`.
